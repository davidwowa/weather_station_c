$(document)
		.ready(
				function() {
					...
					today_logfile = 'log2-' + r_dd + '-' + r_mm + '-' + yyyy
							+ '.csv';
					today_string = r_dd + '.' + r_mm + '.' + yyyy;

					var options = {
						chart : {
							renderTo : 'current_day_container_bmp180',
							type : 'spline'
						},
						title : {
							text : 'Temperature, Altitude and Pressure'
						},
						subtitle : {
							text : 'Source: BMP180'
						},
					...
					$.get(today_logfile, function(data) {
						...
						// Create the chart
						var current_graph_bmp180 = new Highcharts.Chart(options);
					});
				});